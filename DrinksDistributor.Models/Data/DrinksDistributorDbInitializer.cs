...
namespace DrinksDistributor.Models.Data
{
    ...
    public class DrinksDistributorDbInitializer : CreateDatabaseIfNotExists<DrinksDistributorContext>
    {
        ...
        protected override void Seed(DrinksDistributorContext context)
        {
            ...
            CoinType chf005 = new CoinType { Code = "CHF0.05", Currency = chf, Name = "0.05 Swiss franc", Value = 0.05 };
            CoinType chf010 = new CoinType { Code = "CHF0.10", Currency = chf, Name = "0.10 Swiss franc", Value = 0.10 };
            CoinType chf020 = new CoinType { Code = "CHF0.20", Currency = chf, Name = "0.20 Swiss franc", Value = 0.20 };
            CoinType chf050 = new CoinType { Code = "CHF0.50", Currency = chf, Name = "0.50 Swiss franc", Value = 0.50 };
            CoinType chf100 = new CoinType { Code = "CHF1.00", Currency = chf, Name = "1 Swiss franc", Value = 1.00 };
            CoinType chf200 = new CoinType { Code = "CHF2.00", Currency = chf, Name = "2 Swiss francs", Value = 2.00 };
            CoinType chf500 = new CoinType { Code = "CHF5.00", Currency = chf, Name = "5 Swiss francs", Value = 5.00 };
